...
```{r echo=FALSE}
# en_US <- read.table("/Users/ivan/Work_directory/SwiftKey/final/en_US_s/en_US_blogs_sample.txt")
#     #file.path('/Users','ivan','Work_directory','SwiftKey','final','en_US_s/')
# en_US.document <- Corpus(VectorSource(en_US))
# docs <- en_US.document
...
The main functionalities of this application should be:

Detecting the nearest 1 to 4 words of the user input and transfer them as the inputs of our model. 
Example: user input = “we had a”

most frequent phrase beginning with user input = “we had a great”

predicted word = “great”

Other considerations:

removing other common words and profanity

using word “stems” to reduce size of the Document Term Matrix