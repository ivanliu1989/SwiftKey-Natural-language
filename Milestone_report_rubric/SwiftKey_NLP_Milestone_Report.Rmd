...
length(stem_docs)
validWordMatrix<-wordMatrix[,validCharWords]
validWordCount<-colSums(validWordMatrix)
hist(log10(validWordCount), xlab="Word frequency in corpus  (log10)", col = "red", 
     ylab="Number of words", main = "Word frequency distribution")
```
