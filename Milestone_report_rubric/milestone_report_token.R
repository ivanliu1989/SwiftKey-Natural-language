...
write.table(en_US_blogs_sample, file='./SwiftKey-Natural-language/Other/en_US_s/en_US_blogs_sample.txt',row.names = F)
write.table(en_US_news_sample, file='./SwiftKey-Natural-language/Other/en_US_s/en_US_news_sample.txt',row.names = F)
write.table(en_US_twitter_sample, file='./SwiftKey-Natural-language/Other/en_US_s/en_US_twitter_sample.txt',row.names = F)
